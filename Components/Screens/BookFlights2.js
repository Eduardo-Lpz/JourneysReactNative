...
import BookFlights2 from './BookFlights2'
...
export default  class FlightsScreen extends Component {
    ...
    componentDidMount(){
      return fetch('http://192.168.0.11:3001/api/journeys/Apts/')//172.20.19.136:3001
        ...
        <ScrollView>
          ...
          <View style={{height:50}}>
            ...
            onPress={() => this.props.navigation.navigate('Second')}>
              ...
              <Text> Crear Vuelo </Text>
            </Button>
          </View>


                    
          <View  style={{height:200, flex:0}}>
          <Button transparent onPress={()=>console.log(this.state.FechaDeOrigen)} style={{width:55}}>
